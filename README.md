...
A cricket scoring and event management application built with React, TypeScript, and Firebase.

## Features

- 🏏 **Cricket Scoring System** - Complete ball-by-ball scoring with proper cricket rules
- 📱 **Phone Authentication** - OTP-based login system  
- 🎯 **Event Management** - Create events with poster uploads
- 👥 **Team Management** - Manage players and team rosters
